...
export class TemasComponent {
  ...
  constructor(
    ...
    private servicio: AplicaionTemasService,
  ...
  ir(){
    this.router.navigate(['admin/subtemas', this.seleccion.id, this.seleccion.nombre]);
  }
  ...
  buscar(){
    this.datos = this.generales.sublista(this.listado, this.idSeccion, 'idSeccion');
  }
