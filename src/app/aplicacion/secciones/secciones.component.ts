...
export class SeccionesComponent {
  ...
  nuevo(dato: any){
    if(this.servicio.validar(dato)){
      ...
      this.servicio.nuevo(dato).subscribe((respuesta: any) => {
        this.cargando = false;
        this.generales.mensajeCorrecto('Seccion agregada correctamente');
  ...
  modificar(dato: any){
    if(this.servicio.validar(dato)){
      ...
      this.servicio.modificar(dato).subscribe((respuesta: any) => {
        this.cargando = false;
        this.generales.mensajeCorrecto('Seccion modificado correctamente');
  ...
  activar(){
    ...
    this.servicio.activar(this.seleccion).subscribe((respuesta: any) => {
      this.cargando = false;
      this.generales.mensajeCorrecto('Seccion activada correctamente');
      this.datos = this.generales.actualizarDatoArray(this.datos, respuesta);
  ...
  desactivar(){
    ...
    this.servicio.desactivar(this.seleccion).subscribe((respuesta: any) => {
      this.cargando = false;
      this.generales.mensajeCorrecto('Seccion desactiaado correctamente');
      this.datos = this.generales.actualizarDatoArray(this.datos, respuesta);
      this.seleccion = respuesta;
    },
    error => {
  ...
  eliminar(){
    ...
    this.servicio.eliminar(this.seleccion).subscribe((respuesta: any) => {
      this.cargando = false;
      this.generales.mensajeCorrecto('Seccion eliminaao correctamente');
