...
export class DepartamentosService {
  ...
  uri = environment.url+'departamentos/';
  ...
  validar(dato: any){
    if(this.generales.validarString(dato.nombre)){
      this.generales.mensajeError('No se ha ingresado el nombre del departamento')
      return false;
    }
    if(this.generales.validarString(dato.abreviatura)){
      this.generales.mensajeError('No se ha ingresado la abreviatura del departamento')
      return false;
    }
    return true;
  }
