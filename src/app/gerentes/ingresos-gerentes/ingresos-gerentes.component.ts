...
@Component({
  selector: 'app-ingresos-gerentes',
  templateUrl: './ingresos-gerentes.component.html',
  styleUrl: './ingresos-gerentes.component.css'
})
export class IngresosGerentesComponent {
